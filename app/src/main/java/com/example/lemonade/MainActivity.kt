...
class MainActivity : AppCompatActivity() {
    ...
    private fun changeLemonState(state: String) {
        lemonadeState = state
        setViewElements()
    }
    ...
    private fun setViewElements() {
        ...
        when (lemonadeState) {
            SELECT -> {
                setVisualState(R.string.lemon_select, R.drawable.lemon_tree)
            }
            SQUEEZE -> {
                setVisualState(R.string.lemon_squeeze, R.drawable.lemon_squeeze)
            }
            DRINK -> {
                setVisualState(R.string.lemon_drink, R.drawable.lemon_drink)
            }
            RESTART -> {
                setVisualState(R.string.lemon_empty_glass, R.drawable.lemon_restart)
            }
        }
    ...
    private fun setVisualState(actionTextId: Int, image: Int) {
        val textAction: TextView = findViewById(R.id.text_action)

        textAction.text = getString(actionTextId)
